...
root_dir = "/home/tadej/workspace/autokit/"
...
from autokit.data_io import vprint           # print only in verbose mode
from autokit.data_manager import DataManager # load/save data and get info about them
#from models import MyAutoML
from autokit.hyper import KaAutoML as MyAutoML          # example model from scikit learn 
from autokit.hyper import HyperML
...
if __name__=="__main__" and debug_mode<4:	
    ...
    for basename in datanames: # Loop over datasets
        ...
        M = HyperML(D.info, verbose, debug_mode, max_cycle)
        print(M)
        ...
        M.start_fit(D.data['X_train'], D.data['Y_train'])
